...
export const TierCard: React.FC<TierCardProps> = ({ tier, index, contract, isEditing }) => {
    return (
        <div className="max-w-sm flex flex-col justify-between p-6 bg-zinc-900 border border-blue-500 rounded-lg shadow">
            <div>
            ...
            {!isEditing && (<div className="flex flex-row justify-between items-end">
