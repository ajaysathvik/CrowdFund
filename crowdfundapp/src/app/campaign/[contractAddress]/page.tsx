...
import { darkTheme, lightTheme, TransactionButton, useActiveAccount, useReadContract } from "thirdweb/react";
        ...
        <div className="fixed inset-0 bg-black bg-opacity-75 flex justify-center items-center backdrop-blur-md">
            <div className="w-1/2 bg-zinc-900 p-6 rounded-md">
                <div className="flex justify-between items-center mb-4">
                    ...
                    <button
                        className="text-sm px-4 py-2 bg-zinc-600 text-white rounded-md"
                ...
                <div className="flex flex-col">
                    ...
                    <input 
                        ...
                        className="mb-4 px-4 py-2 bg-zinc-500 rounded-lg"
                    />
