...
export default function DashboardPage() {
  ...
  return (
    <div className="mx-auto px-4 mt-16 sm:px-6 lg:px-8">
...
const CreateCampaignModal = ({
  ...
  const handleDeployContract = async () => {
    ...
    try {
      ...
      const contractAddress = await deployPublishedContract({
        ...
        publisher: "0x061D07DfFD3cE49374bF4674B535cadbd8Ef042F",
        version: "1.0.1",
      });
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-75 flex justify-center items-center backdrop-blur-md">
      <div className="w-1/2 bg-zinc-900 p-6 rounded-md">
        <div className="flex justify-between items-center mb-4">
          <p className="text-lg font-semibold">Create a Campaign</p>
          <button
            className="text-sm px-4 py-2 bg-zinc-700 text-white rounded-md"
        ...
        <div className="flex flex-col">
          ...
          <input
            ...
            className="mb-4 px-4 py-2 bg-zinc-700 rounded-md"
          />
